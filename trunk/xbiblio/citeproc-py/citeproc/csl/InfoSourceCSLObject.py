...
class InfoSourceCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoSourceCSLObject, self).__init__(attrs)
    
    def xml(self):
        return "<source>%s</source>\n" % (ParentCSLObject.xml(self),)


class InfoSourceCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
