...
class SubstituteCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(SubstituteCSLObject, self).__init__(attrs)
...
class SubstituteCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
