...
class InfoSummaryCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoSummaryCSLObject, self).__init__(attrs)

    def xml(self):
        return "<summary>%s</summary>\n" % (ParentCSLObject.xml(self),)


class InfoSummaryCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
