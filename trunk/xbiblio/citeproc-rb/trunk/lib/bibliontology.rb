...
module Bibliontology
  ...
  module Wgs84_pos
    class SpatialThing
      ...
      def initialize(latitude = 0, longitude = 0, altitude = 0)
        @latitude = latitude
        @longitude = longitude
        @altitude = altitude
      end
  ...
  @@contributor   = ContributionRole.new
  @@author        = ContributionRole.new
  @@editor        = ContributionRole.new
  @@translator    = ContributionRole.new
  @@interviewer   = ContributionRole.new
  @@interviewee   = ContributionRole.new
  @@recipient     = ContributionRole.new
