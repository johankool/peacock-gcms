...
class InfoRightsCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoRightsCSLObject, self).__init__(attrs)
    
    def xml(self):
        return "<rights>%s</rights>\n" % (ParentCSLObject.xml(self),)

class InfoRightsCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
