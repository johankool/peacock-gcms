...
class InfoContributorCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoContributorCSLObject, self).__init__(attrs)

    def xml(self):
        return "<contributor>\n%s\n</contributor>\n" % (ParentCSLObject.xml(self),)


class InfoContributorCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
