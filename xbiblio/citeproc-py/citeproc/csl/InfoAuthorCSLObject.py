...
class InfoAuthorCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoAuthorCSLObject, self).__init__(attrs)

    def xml(self):
        return "<author>\n%s\n</author>\n" % (ParentCSLObject.xml(self),)
        
class InfoAuthorCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
