...
class InfoTitleCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoTitleCSLObject, self).__init__(attrs)
    
    def xml(self):
        return "<title>%s</title>\n" % (ParentCSLObject.xml(self),)


class InfoTitleCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
