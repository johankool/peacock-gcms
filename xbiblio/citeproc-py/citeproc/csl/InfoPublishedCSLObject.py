...
class InfoPublishedCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoPublishedCSLObject, self).__init__(attrs)

    def xml(self):
        return "<published>%s</published>\n" % (ParentCSLObject.xml(self),)


class InfoPublishedCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
