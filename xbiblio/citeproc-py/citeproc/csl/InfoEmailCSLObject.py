...
class InfoEmailCSLObject(ParentCSLObject):
    def __init__(self, attrs):
        super(InfoEmailCSLObject, self).__init__(attrs)
    
    def xml(self):
        return "<email>%s</email>\n" % (ParentCSLObject.xml(self),)

class InfoEmailCSLObjectTests(unittest.TestCase):
    def setUp(self):
        pass
