...
+ (id)gradientWithBeginningColor:(NSColor *)begin endingColor:(NSColor *)end
  ...
  [newInstance addColorStop:begin atPosition:0];
  [newInstance addColorStop:end   atPosition:1];
...
- (void)addColorStop:(NSColor *)color atPosition:(float)position
  {
...
//Removes the color stop at <position> from elementList - if not found returns NO
