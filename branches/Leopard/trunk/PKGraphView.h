...
- (PKPeak *)peakAtPoint:(NSPoint)aPoint;
...
@property BOOL _startedResizePlottingAreaLeft;
@property BOOL _startedInsidePlottingArea;
@property BOOL _startedResizePlottingAreaRight;
@property BOOL _startedResizePlottingAreaBottom;
@property float _lowestYOriginLabelsXAxis;
@property int _lastSelectedPeakIndex;
@property float _lowestXOriginLabelsYAxis;
@property BOOL _startedInsideLegendArea;
@property BOOL _didDrag;
@property BOOL _startedResizePlottingAreaTop;
@property (retain) NSArrayController *baselineContainer;
@property (retain) NSString *baselineKeyPath;
@end
