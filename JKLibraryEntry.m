...
////        [coder encodeInt:3 forKey:@"version"]; // done in super
//        if (name)
...
//        if (epaMassSpecNo)
//            [coder encodeObject:epaMassSpecNo forKey:@"epaMassSpecNo"];
//        
//        if (formula)
//            [coder encodeObject:formula forKey:@"formula"];
//        if (massWeight)
//            [coder encodeObject:massWeight forKey:@"massWeight"];
//        if (nistSource)
//            [coder encodeObject:nistSource forKey:@"nistSource"];
//        if (ionizationEnergy)
//            [coder encodeObject:ionizationEnergy forKey:@"ionizationEnergy"];
//        if (xUnits)
//            [coder encodeObject:xUnits forKey:@"xUnits"];
//        if (yUnits)
//            [coder encodeObject:yUnits forKey:@"yUnits"];
//        if (xFactor)
//            [coder encodeObject:xFactor forKey:@"xFactor"];
//        if (yFactor)
//            [coder encodeObject:yFactor forKey:@"yFactor"];
//        if (retentionIndex)
...
//        // Peacock additions
//        if (synonyms)
//            [coder encodeObject:synonyms forKey:@"synonyms"];
//        if (comment)
...
//        if (modelChr)
//            [coder encodeObject:modelChr forKey:@"modelChr"];
//        if (group)
...
//                modelChr = [[coder decodeObjectForKey:@"modelChr"] retain];
